...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item $\text{col}\,B \subset \text{col}\,A$ (equivalently $\text{span}(\cal{B}) \subset \text{span}(\cal{A})$) iff $\text{pref}[\begin{amatrix}{1}A & B\end{amatrix}]$ has no pivots in the columns at the positions occupied by $B$.
    ...
    \item (Follow Up Problem 14.8) For two subspaces $U$ and $V$,
    \begin{align*}
            U\cap V = U + V\qquad\Leftrightarrow\qquad U = V
    \end{align*}
\end{enumerate}