...
\begin{enumerate}
    ...
    $A-\lambda I = \left[\begin {matrix} u&v \\ w&y\end{matrix}\right] \Rightarrow (A-\lambda I){\textbf x}={\textbf 0}$ when ${\textbf x}=\left[\begin{matrix}-v \\ u\end{matrix}\right]$ or ${\textbf x}=\left[\begin{matrix}-y \\ w\end{matrix}\right]$
    \begin{enumerate}
